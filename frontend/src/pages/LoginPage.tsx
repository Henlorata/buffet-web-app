...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] animate-in fade-in duration-500">
        {loading ? (<div className="flex flex-col items-center justify-center min-h-[50vh] text-amber-500 gap-4">
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-3xl shadow-xl border border-gray-100 space-y-8">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-extrabold text-gray-900">Üdvözlünk <span className="text-amber-500">újra!</span></h1>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-2 text-gray-400">Vagy</span></div>
          </div>
