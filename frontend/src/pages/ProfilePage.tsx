...
const ViewProfilePage: React.FC = () => {
  ...
  const roleConfig: Record<string, any> = {
    'V': { label: 'Vásárló', headerColor: 'from-blue-600 to-indigo-700', badgeColor: 'bg-blue-50 text-blue-700', dotColor: 'bg-blue-500' },
    'A': { label: 'Admin', headerColor: 'from-amber-500 to-orange-600', badgeColor: 'bg-amber-50 text-amber-700', dotColor: 'bg-amber-500' },
    'P': { label: 'Pultos', headerColor: 'from-emerald-500 to-teal-600', badgeColor: 'bg-emerald-50 text-emerald-700', dotColor: 'bg-emerald-500' }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 px-4">
      <div className="mb-8">
        <p className="text-gray-500 mt-2">Itt módosíthatod személyes adataidat.</p>
      </div>
      ...
      <div className="bg-white shadow-xl border border-gray-100 rounded-3xl overflow-hidden mb-10">
        ...
        <div className="px-8 pb-10">
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-400 uppercase ml-1">Fiók létrejötte</label>
              <p
                id="time"
                className="w-full bg-gray-50 border border-gray-200 py-3 px-4 rounded-xl outline-none focus:ring-2 focus:ring-blue-500"
              >
